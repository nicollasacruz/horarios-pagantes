...
<template>
    <div>
        <div class="bg-gray-100" style="width: 100%;">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('fortune-ox')" :active="route().current('fortune-ox')">
                                    Fortune OX
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('hallow-win')" :active="route().current('hallow-win')">
                                    Mr. Hallow-Win!
                                </NavLink>
                            </div>
                        </div>
            ...
            <!-- Page Heading -->
            <header class="bg-gray-800 shadow text-white" v-if="$slots.header">
