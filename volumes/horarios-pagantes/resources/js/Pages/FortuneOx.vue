...
const fundo = `background-image: url(${BgFortuneOx})`;
const fundoMobile = `background-image: url(${BgFortuneOxMobile})`;
const box = `background-image: url(${BoxFortuneOx})`;
const boxMobile = `background-image: url(${BoxFortuneOxMobile})`;
